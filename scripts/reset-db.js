...
async function resetDatabase() {
  ...
  try {
    ...
    const emprestimo3 = await prisma.emprestimo.create({
      data: {
        userId: user.id,
    ...
    const emprestimos = [emprestimo1, emprestimo2, emprestimo3];
    ...
    console.log('\n🎉 Reset e população do banco concluída com sucesso!');
...
resetDatabase()
  .catch((e) => {
    console.error('❌ Erro durante o reset do banco:', e);
    process.exit(1);
  })
  .finally(async () => {
